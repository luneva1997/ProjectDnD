...
class AdventureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        menu.setPicture(R.drawable.adventure)
        circle.setPictures(R.drawable.character, R.drawable.location, R.drawable.npc, R.drawable.qwest, R.drawable.note2)
        first.invalidate()
        second.invalidate()
        third.invalidate()
        fourth.invalidate()
    ...
    fun firstNavigation(){
        val intent = Intent(this, com.example.begin.CharacterListActivity::class.java)
