...
class LocationActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var viewpage = findViewById<ViewPager2>(R.id.viewpager)
        viewpage.adapter = adapter

        TabLayoutMediator(findViewById<TabLayout>(R.id.tab_layout),viewpage){
            tab,position ->
        ...
        menu.setPicture(R.drawable.location)
        circle.setPictures(R.drawable.adventure, R.drawable.character, R.drawable.npc, R.drawable.qwest, R.drawable.note2)
        first.invalidate()
        second.invalidate()
        third.invalidate()
        fourth.invalidate()
